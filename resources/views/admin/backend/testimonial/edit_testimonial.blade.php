                    ...
                    <div class="card-body">
                        <form action="{{ route('update.testimonial') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="review" class="form-control" rows="3">{{ $testimonial->review }}</textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <img id="show_image" src="{{ $testimonial->image ? asset($testimonial->image) : url('upload/no_image.jpg') }}" class="rounded img-thumbnail" style="width: 100px; height: 100px; object-fit:cover" alt="Image">
                            </div>
