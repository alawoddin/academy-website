                    ...
                    <div class="card-body">
                        <form action="{{ route('update.team') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="subject" class="form-control" value="{{ $team->subject }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Rating</label>
                                <input type="text" name="rating" class="form-control" value="{{ $team->rating }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Hours</label>
                                <input type="text" name="hours" class="form-control" value="{{ $team->hours }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <img id="show_image" src="{{ $team->image ? asset($team->image) : url('upload/no_image.jpg') }}" class="rounded img-thumbnail" style="width: 100px; height: 100px; object-fit:cover" alt="Image">
                            </div>
