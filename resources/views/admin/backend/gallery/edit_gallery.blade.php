                    ...
                    <div class="card-body">
                        <form action="{{ route('update.gallery') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <img id="show_image" src="{{ $gallery->image ? asset($gallery->image) : url('upload/no_image.jpg') }}" class="rounded img-thumbnail" style="width: 100px; height: 100px; object-fit:cover" alt="Image">
                            </div>
