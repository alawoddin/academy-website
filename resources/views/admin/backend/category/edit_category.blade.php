                    ...
                    <div class="card-body">
                        <form action="{{ route('update.category') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="rating" class="form-control" value="{{ $category->rating }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Teachers</label>
                                <input type="text" name="teachers" class="form-control" value="{{ $category->teachers }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Hours</label>
                                <input type="text" name="hours" class="form-control" value="{{ $category->hours }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <img id="show_image" src="{{ $category->image ? asset($category->image) : url('upload/no_image.jpg') }}" class="rounded img-thumbnail" style="width: 100px; height: 100px; object-fit:cover" alt="Image">
                            </div>
