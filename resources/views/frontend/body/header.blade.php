          ...
          <div class="main-menu__block">
            <div class="main-menu__left">
              ...
              <div class="main-menu__logo">
                <a href="https://uiparadox.co.uk/templates/educate/index.html">
                    Khedmat
              ...
              <div class="main-menu__nav">
                <ul class="main-menu__list">
                  <li class="dropdown">
                    ...
                    <ul>
                      <li><a href="https://uiparadox.co.uk/templates/educate/index.html" class="active">Home 1</a></li>
                  ...
                  <li class="dropdown ">
                    <a href="javascript:void(0);">Instuctors</a>
                    <ul>
            ...
            <div class="main-menu__right">
              ...
              <a href="contact.html" class="educate-btn sm d-xl-flex d-none"><span
