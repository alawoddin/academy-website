...
<head>
  ...
  <link rel="stylesheet" href="{{asset('frontend/assets/vendor/nice-select/nice-select.css')}}">
...
<body class="custom-cursor locked">
  ...
  <script src="{{asset('frontend/assets/vendor/nice-select/jquery.nice-select.min.js')}}"></script>
