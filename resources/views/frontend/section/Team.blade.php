      ...
      <div class="row align-items-center">
        ...
        <div class="col-xl-7">
          <div class="team-slider py-60 ms-2 ms-xl-0">
            ...
            <div class="team__card mb-24">
              <div class="team__img_block">
                <img src="{{ asset('frontend/assets/media/team/Card-2.png') }}" alt="Mike Noah" class="team_img">
                <div class="team__content_block">
                  <div class="team__text_block">
                    <h5 class="mb-8"><a href="{{ url('/') }}#team">Mike Noah </a></h5>
                    <ul class="team__info unstyled mb-16">
                      <li><i class="fas fa-star"></i>5</li>
            ...
            <div class="team__card mb-24">
              <div class="team__img_block">
                <img src="{{ asset('frontend/assets/media/team/Card-3.png') }}" alt="Sophia Parker" class="team_img">
                <div class="team__content_block">
                  <div class="team__text_block">
                    <h5 class="mb-8"><a href="{{ url('/') }}#team">Sophia Parker</a></h5>
                    <ul class="team__info unstyled mb-16">
                      <li><i class="fas fa-star"></i>5</li>
            ...
            <div class="team__card mb-24">
              <div class="team__img_block">
                <img src="{{ asset('frontend/assets/media/team/Card-4.png') }}" alt="Mia Thompson" class="team_img">
                <div class="team__content_block">
                  <div class="team__text_block">
                    <h5 class="mb-8"><a href="{{ url('/') }}#team">Mia Thompson</a></h5>
                    <ul class="team__info unstyled mb-16">
                      <li><i class="fas fa-star"></i>5</li>
            ...
            <div class="team__card mb-24">
              <div class="team__img_block">
                <img src="{{ asset('frontend/assets/media/team/Card-5.png') }}" alt="Mia Thompson" class="team_img">
                <div class="team__content_block">
                  <div class="team__text_block">
                    <h5 class="mb-8"><a href="{{ url('/') }}#team">Mia Thompson</a></h5>
                    <ul class="team__info unstyled mb-16">
